...
class MeasurementController(BaseController):
    ...
    def buildZip(self, list_meas):
        ...
        if len(references) > 0:
            msg = "Your selection contains reference(s) to other(s) website(s). Guilty measurement(s) id(s) : " + str(references) + ". BioRepo didn't find any file in its database. It is not yet able to zip referenced file(s). Contact the administrator if this feature is usefull for you and your lab."
        else:
            ...
            msg = "A 24h available public link was generated by BioRepo. You can download your .zip file here : http://biorepo.epfl.ch/biorepo/public/getZip?pzip=" + path_to_give
        return msg
